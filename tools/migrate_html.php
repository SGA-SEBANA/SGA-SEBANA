...
foreach ($files as $file) {
    ...
    // We look for <div class="page-container"> ... <div class="main-content">
    ...
    // We want the inner content of <div class="main-content">...</div>
    // Regex is tricky with nested divs, but let's try to match the specific container structure if possible.
    // Or just a simple text extraction between class="main-content"> AND <div class="row"> ...
    // Let's try to find the start of "main-content" and extract everything until the closing div of main-content.
    // Since we can't reliably parse nested divs with regex, and DOMDocument is robust but might be strict on HTML5 validity.
    // Let's try DOMDocument.

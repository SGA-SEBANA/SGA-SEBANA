    ...
    <div class="col-lg-8 offset-lg-2">
        ...
        <div class="card shadow-sm mt-4">
            <div class="card-header py-3">
                <strong class="card-title">Nueva Solicitud</strong> de Ayuda Económica
            </div>
                ...
                <form action="/SGA-SEBANA/public/ayudas/store" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group mb-4">
                        ...
                        <div class="col-12 col-md-9">
                            <textarea name="motivo" id="motivo" rows="5" placeholder="Explique su situación..." class="form-control" required></textarea>
                        </div>
                    </div>

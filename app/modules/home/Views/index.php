...
<div class="row m-t-25">
    ...
    <div class="col-sm-6 col-lg-3 d-flex">
        <div class="overview-item overview-item--c1 w-100">
            <div class="overview__inner">
                ...
                <div class="overview-chart">
                    <div style="color: rgba(255,255,255,0.8); font-size:13px; text-align:right; padding-right:20px;">
                        Activos:
                        <strong><?= $stats['afiliados']['activos'] ?></strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- PUESTOS -->
    <div class="col-sm-6 col-lg-3 d-flex">
        <div class="overview-item overview-item--c2 w-100">
            <div class="overview__inner">
                <div class="overview-box clearfix">
                    <div class="icon">
                ...
                <div class="overview-chart">
                    <div style="color: rgba(255,255,255,0.8); font-size:13px; text-align:right; padding-right:20px;">
                        Ocupados:
                        <strong><?= $stats['puestos']['activos'] ?></strong>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- JUNTA DIRECTIVA -->
    <div class="col-sm-6 col-lg-3 d-flex">
        <div class="overview-item overview-item--c3 w-100">
            <div class="overview__inner">
                <div class="overview-box clearfix">
                    <div class="icon">
    ...
    <!-- USUARIOS / LOGS -->
    <div class="col-sm-6 col-lg-3 d-flex">
        <div class="overview-item overview-item--c4 w-100">
            <div class="overview__inner">
                <div class="overview-box clearfix">
                    <div class="icon">
    ...
    <div class="col-lg-8">
        <div class="au-card recent-report">
            <div class="au-card-inner">
                ...
                <h3 class="title-2">
                    Crecimiento de Afiliados (Últimos 6 Meses)
                </h3>
    ...
    <div class="col-lg-8">
        ...
        <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
            ...
            <div class="au-card-title"
                 style="background-image:url('/SGA-SEBANA/public/assets/img/bg-title-01.jpg');">

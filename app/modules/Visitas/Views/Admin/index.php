            ...
            <table class="table table-data2">
                ...
                <tbody>
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td><?= htmlspecialchars($s['codigo_solicitud']) ?></td>
                        ...
                        <td><?= htmlspecialchars($s['fecha_visita']) ?></td>
                        ...
                        <td>
                            ...
                            <span class="status--process">Aprobada</span>

                            <?php elseif ($s['estado'] == 'rechazada'): ?>
                            <span class="status--denied">Rechazada</span>

                            <?php else: ?>
                            <span><?= htmlspecialchars($s['estado']) ?></span>
                            <?php endif; ?>
